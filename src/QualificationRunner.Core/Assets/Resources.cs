...
namespace QualificationRunner.Core.Assets
{
   ...
   public static class Errors
   {
      ...
      public static string ProjectConfigurationNotValid(string project, string logFile) => $"Project configuration for '{project}' is not valid. Please check log file at '{logFile}' for details.";
